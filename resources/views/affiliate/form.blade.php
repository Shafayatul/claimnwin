<div class="grids widget-shadow">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group {{ $errors->has('is_payment_done') ? 'has-error' : ''}}">
                {!! Form::label('is_payment_done', 'Payment Status', ['class' => 'control-label']) !!}
                {!! Form::select('is_payment_done', ['0'=> 'Not done', '1'=> 'Complete'], null, ('' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
                {!! $errors->first('is_payment_done', '<p class="help-block">:message</p>') !!}
            </div>
        </div>
    </div>
    <div class="row">
