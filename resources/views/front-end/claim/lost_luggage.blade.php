...
<link rel="stylesheet" type="text/css" href="{{ asset('front_asset/') }}/claim/lost_luggage/css/main.css">
<!--===============================================================================================-->
                                ...
                                <div class="common_row">
                                    ...
                                    <div class="parent_div">
                                        ...
                                        <p>A Property Irregularity Report (PIR) reference number is a unique code that helps trace your delayed or damaged baggage.
                                            ...
                                            For help locating your PIR please contact our <a  style="font-weight: bold; color: #124478;" target="_blank"  href="{{url('/contact-us')}}">Customer Service Department</a>.
                                        </p>
                                    </div>
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 fifty_percent_width">
                                                                    <div class="select_reason_class">
                                                                        <select class="form-control custom_select expense_currency_select_option select_accomodation_currency">
                                                                            <option selected>select currency</option>
                                                                            @foreach($currencies as $key => $val)
                                                                                <option value="{{$key}}">{{$key}}</option>
                                                                            @endforeach
