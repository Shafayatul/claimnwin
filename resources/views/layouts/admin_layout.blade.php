              ...
              <ul class="sidebar-menu">
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="grids.html"><i class="fa fa-angle-right"></i> Add Airline</a></li>
                    <li><a href="media.html"><i class="fa fa-angle-right"></i> Manage Airline</a></li>
                  </ul>
                </li>
                <li class="treeview">
                  <a href="#">
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="grids.html"><i class="fa fa-angle-right"></i> Add Claim</a></li>
					...
					<ul class="nofitications-dropdown">
						<li class="dropdown head-dpdn">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#">
								   <div class="user_img"><img src="{{ URL::asset('admin_asset/images/1.png')}}" alt=""></div>
								...
								<li class="odd"><a href="#">
									<div class="user_img"><img src="{{ URL::asset('admin_asset/images/4.jpg')}}" alt=""></div>
								   <div class="notification_desc">
									<p>Lorem ipsum dolor amet </p>
									<p><span>1 hour ago</span></p>
									</div>
								...
								<li><a href="#">
								   <div class="user_img"><img src="{{ URL::asset('admin_asset/images/3.jpg')}}" alt=""></div>
								   <div class="notification_desc">
									<p>Lorem ipsum dolor amet </p>
									<p><span>1 hour ago</span></p>
									</div>
								...
								<li><a href="#">
								   <div class="user_img"><img src="{{ URL::asset('admin_asset/images/2.jpg')}}" alt=""></div>
								   <div class="notification_desc">
									<p>Lorem ipsum dolor amet </p>
									<p><span>1 hour ago</span></p>
									</div>
