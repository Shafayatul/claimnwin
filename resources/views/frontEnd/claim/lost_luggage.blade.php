            ...
            <div class="common_row">
              ...
              <div class="form_show_message_paragraph">
                <p>
                  ...
                  You are eligible to a refund of up to 1350 EUR (Show on screen the amount in the currency converted according to passengers IP)  per passenger.
                </p>
                <p>
...
@section('footer-script')
  ...
  <script src="{{('front_asset/claim/lost_luggage/js/select.js')}}"></script>
