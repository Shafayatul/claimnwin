      ...
      <form action="">
        ...
        <div class="single_step" id="step_2" style="display:none;">
          ...
          <div class="common_row show_on_canceled_flight">
            <div class="parent_div">
              <div class="form_h3">
                <h3>What was the total delay once you arrived at your final destination (Tel Aviv-Yafo (TLV))?</h3>
              </div>
            </div>
            <div class="parent_div">
          ...
          <div class="common_row show_on_canceled_flight_notify">
            <div class="parent_div">
              <div class="form_h3">
            ...
            <div class="parent_div">
              <div class="total_delay_flight_2">
                <label class="container_radio">Less than 14 days
                  <input type="radio" class="common_input" id="common_input total_delay_radio" name="total_cancel_radio_notify" value="1">
                  <span class="checkmark"></span>
                </label>
              </div>
              <div class="total_delay_flight_2">
                <label class="container_radio">More than 14 days
                  <input type="radio" class="common_input" id="common_input total_delay_radio" name="total_cancel_radio_notify" value="2">
                  <span class="checkmark"></span>
                </label>
              </div>
          </div>
        ...
        <div class="common_row show_on_total_cancel_radio_selected">
          <div class="parent_div">
            <div class="form_h3">
