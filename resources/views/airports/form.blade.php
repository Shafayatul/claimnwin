...
<div class="form-group {{ $errors->has('municipality') ? 'has-error' : ''}}">
    ...
    {!! Form::text('municipality', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('latitude') ? 'has-error' : ''}}">
    ...
    {!! Form::text('latitude', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('longitude') ? 'has-error' : ''}}">
    ...
    {!! Form::text('longitude', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('home_link') ? 'has-error' : ''}}">
    ...
    {!! Form::text('home_link', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
...
<div class="form-group {{ $errors->has('wikipedia_link') ? 'has-error' : ''}}">
    ...
    {!! Form::text('wikipedia_link', null, ('required' == 'required') ? ['class' => 'form-control', 'required' => 'required'] : ['class' => 'form-control']) !!}
