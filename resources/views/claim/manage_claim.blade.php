        ...
        <div class="form-grids row widget-shadow" data-example-id="basic-forms">
            ...
            <div class="form-body">
              <div class="card">
                    ...
                    <div class="card-body">
                      {!! Form::open(['method' => 'GET', 'url' => url()->current(), 'class' => 'form-inline my-2 my-lg-0 float-right', 'role' => 'search']) !!}
                      <div class="row">
                        <div class="col-md-2">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <div class="input-group">
                              <input type="text" class="form-control" id="myInput" name="s_airline" placeholder="Airline name" value="{{ request('s_airline') }}" autocomplete="off">
