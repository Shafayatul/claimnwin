$(document).ready(function(){
    ...
    $(".show_on_canceled_flight").hide(500);
    ...
    $(".show_on_total_cancel_radio_selected").hide(500);

    $("input[name=total_delay_radio]:radio").click(function() {
        if($(this).attr("value")=="1") {
          $(".show_on_canceled_flight_notify").show(500);
          $(".show_on_total_cancel_radio_selected").hide(500);
    ...
    //   $("input[name=total_cancel_radio_1]:radio").click(function() {
    //     if($(this).attr("value")=="1") {
    //       console.log("");
    //       $(".show_on_canceled_flight_notify").show(500);
    //       $(".show_on_total_delay_radio_selected").hide(500);
