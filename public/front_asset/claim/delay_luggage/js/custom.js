    ...
    function ajax_calculation(){
      ...
      $.ajax({
        ...
        success: function (data){
          ...
          */
          var a_html = '';
          a_html = a_html+'<p><b>Have you already written to the airline: </b>'+$('input[name="is_already_written_airline"]:checked').val()+'</p>';
          a_html = a_html+'<p><b>What date did you write to the airline: </b>'+$('input[name="written_airline_date"]').val()+'</p>';
          a_html = a_html+'<p><b>PIR: </b>'+$('input[name="pir"]').val()+'</p>';
          a_html = a_html+'<p><b>When did you receive your luggage: </b>'+$('input[name="received_luggage_date"]').val()+'</p>';
        ...
        if (step == 0) {
            ...
            if (($("input[name='departed_from']").val() != "") && ($("input[name='final_destination']").val() != "")) {
                ...
                if (step_two_airline &&
                    ...
                    step_two_departure_date && step_two_flight_code) {
